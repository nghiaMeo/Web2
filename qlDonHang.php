                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM  ticket_details td, payment_details pd WHERE td.pnr = pd.pnr ORDER BY booking_status  DESC ";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center text-muted"><?php
                                                                            ...
                                                                            ?>
                                                <a href="confirmticket.php?pnr=<?= $row['pnr'] ?>"><button type="button" class="mr-2 btn-icon btn-icon-only btn btn-outline-primary">CONFIRM</button></a>
                                            <?php
                                                                            } else { ?>
